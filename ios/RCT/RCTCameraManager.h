...
- (void)setZoom;
- (void)changeISO:(int)value;
- (void)getISORange:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject;
- (void)getAudioLevel:(RCTPromiseResolveBlock)resolve reject:(RCTPromiseRejectBlock)reject;
